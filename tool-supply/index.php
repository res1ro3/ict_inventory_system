...
<body>
    ...
    <div class="tbl_manage_inventory">
        <div class="dashboard-header" style="margin: 2rem 0">
            ...
            <div>
                <table id="tools_suppliesTbl" class="display table table-light" style="width:100%">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Type of Supplies/Tools</th>
                            <th>Quantity</th>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <form class="needs-validation" novalidate id="updateForm" name="updateForm" method="post">
                    <input type="hidden" class="form-control" id="stidInpEdit" name="stidInpEdit">

                    <div class="mb-3 col form-floating">
                        <input type="text" class="form-control" id="typeoftoolsuppInpEdit" name="typeoftoolsuppInpEdit" required>
                        <label for="typeoftoolsuppInpEdit" class="form-label fw-bold">Type of Tool/Supply</label>
                    ...
                    <div class="mb-3 col form-floating">
                        ...
                        <label for="quantityInpEdit" class="form-label fw-bold">Quantity</label>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3 col">
                        <label for="specificationsInpEdit" class="form-label fw-bold ps-2 text-secondary" id="specificationsEditInpLbl">Specifications</label>
                        <textarea class="form-control" id="specificationsInpEdit" name="specificationsInpEdit" rows="4" cols="50" placeholder="Enter specification here" required></textarea>
                    ...
                    <div class="mb-3 form-floating">
                        ...
                        <label for="unitInpEdit" id="officeLbl" class="form-label fw-bold">Office</label>
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3 form-floating">
                        ...
                        <label for="ownerInpEdit" class="form-label fw-bold">Owner</label>
                    </div>
                </form>
                </div>
    ...
    <script>
        ...
        function getEdit(stid) {
            $.ajax({
                type: "GET",
                url: "./get.php",
                data: {supply_tool_id:stid}
            }).then((res) => {
                    res = JSON.parse(res);
                    $("#stidInpEdit").val(res.supply_tools_id);
                    $("#typeoftoolsuppInpEdit").val(res.type_of_supply_tools);
                    $('#quantityInpEdit').val(res.quantity);
                    $('#specificationsInpEdit').val(res.specifications_remarks);
        ...
        function update() {
            $.ajax({
                ...
                url: "./update.php",
                data: {
                    supply_tools_id: $("#stidInpEdit").val(),
                    type_of_supply_tools: $("#typeoftoolsuppInpEdit").val(),
